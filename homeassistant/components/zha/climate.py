...
from .core.const import (
    DATA_ZHA, DATA_ZHA_DISPATCHERS, ZHA_DISCOVERY_NEW, CHANNEL_THERMOSTAT,
    CHANNEL_FAN, SIGNAL_SET_FAN, SIGNAL_ATTR_UPDATED
)
from .sensor import temperature_formatter
from .entity import ZhaEntity
from .fan import SPEED_ON, SPEED_AUTO, SPEED_SMART
...
class ZhaThermostat(ZhaEntity, ClimateDevice):
    ...
    def __init__(self, unique_id, zha_device, channels, **kwargs):
        ...
        self._thermostat_channel = self.cluster_channels.get(CHANNEL_THERMOSTAT)
